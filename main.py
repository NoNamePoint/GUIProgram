...
class Main(tk.Frame):
    ...
    def set_record(self, entry_expance, rvbar, entry_expance_sum):
...
class AddExpance(tk.Toplevel):
    def __init__(self):
        ...
        self.button_accept = tk.Button(self, text=u"Добавить", command= lambda: self.view.records(self.entry_expense.get(),
                                                                                                  self.rvbar.get(),
...
class UpdateExpance(AddExpance):
    def __init__(self):
        ...
        self.view.set_record(self.entry_expense, self.rvbar, self.entry_expense_sum)
